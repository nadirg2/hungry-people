              ...
              <div className={styles.main__row}>
                ...
                <div className={styles.main__content}>
                  ...
                  <div className={styles.main__buttons}>
                    ...
                    <OutlineButton width='200px'>
                      EXPLORE
                    </OutlineButton>
                  </div>
                </div>
                <div className={styles["social-network"]}>
                  <div className={styles["social-network__item"]}><FontAwesomeIcon icon={ faFacebookF } /></div>
                  <div className={styles["social-network__item"]}><FontAwesomeIcon icon={ faTwitter } /></div>
                  <div className={styles["social-network__item"]}><FontAwesomeIcon icon={ faInstagram } /></div>
                </div>
                <div className={styles["down-btn"]}>
                  <div className={styles["down-btn__top-line"]}/>
                  <div className={styles["down-btn__ellipse"]}>
                    <div className={styles["down-btn__btn"]}><FontAwesomeIcon icon={ faAngleDown } /></div>
                  </div>
